...
class InstagramBot():
    ...
    def like_photo_by_hashtag(self, hashtag):
        ...
        for url in posts_urls:
            try:
                browser.get(url)
                time.sleep(3)
                like_button = browser.find_element("xpath",
    ...
    def xpath_exists(self, url):
        ...
        browser = self.browser
        try:
            browser.find_element("xpath",url)
            exist = True
    ...
    def get_all_followers(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            followers_ul = browser.find_element("xpath","/html/body/div[1]/div/div[1]/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div[2]")
                        ...
                        try:
                            ...
                            if self.xpath_exists("/html/body/div[1]/div/div[1]/div/div[1]/div/div/div/div[1]/div[1]/section/main/div/header/section/div[1]/div[1]/div/a"):
                                ...
                                if self.xpath_exists(
                                        "/html/body/div[1]/div/div[1]/div/div[1]/div/div/div/div[1]/div[1]/section/main/div/div/article/div[1]/div/h2"):
                                    try:
...
my_bot.login()
my_bot.get_all_followers('https://www.instagram.com/dayce.digitrade/?hl=en')
